...
describe("Dependency Graph", function () {
    describe("createFromResolvedFiles", function () {
        ...
        describe("Cyclic dependencies", function () {
            ...
            before("Get project root", async function () {
                localResolver = new resolver_1.Resolver(await (0, project_1.getFixtureProjectPath)(PROJECT), new parse_1.Parser(), (absolutePath) => fs_extra_1.default.readFile(absolutePath, { encoding: "utf8" }));
            });
    ...
    describe("getConnectedComponents", function () {
        it("single file", async function () {
            ...
            const [graph, [Foo]] = await (0, helpers_1.createMockData)([{ file: FooMock }]);
        ...
        it("two independent files", async function () {
            ...
            const [graph, [Foo, Bar]] = await (0, helpers_1.createMockData)([
                { file: FooMock },
                { file: BarMock },
            ]);
            const connectedComponents = graph.getConnectedComponents();
        ...
        it("one file imports a library", async function () {
            ...
            const [graph, [Foo, Lib]] = await (0, helpers_1.createMockData)([
        ...
        it("three files sequential import", async function () {
            ...
            const [graph, [Foo, Bar, Qux]] = await (0, helpers_1.createMockData)([
                { file: FooMock, dependencies: [BarMock] },
        ...
        it("four files, Foo1->Foo2 and Bar1<->Bar2", async function () {
            ...
            const [graph, [Foo1, Foo2, Bar1, Bar2]] = await (0, helpers_1.createMockData)([
        ...
        it("five files, three layers, 2-1-2", async function () {
            ...
            const [graph, resolvedFiles] = await (0, helpers_1.createMockData)([

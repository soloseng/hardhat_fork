...
describe("lazy module", () => {
    describe("lazyObject", () => {
        ...
        it("doesn't support classes", () => {
            ...
            (0, errors_1.expectHardhatError)(() => (obj.asd = 123), errors_list_1.ERRORS.GENERAL.UNSUPPORTED_OPERATION);
            (0, errors_1.expectHardhatError)(() => obj.asd, errors_list_1.ERRORS.GENERAL.UNSUPPORTED_OPERATION);
...
describe("lazy import", () => {
    ...
    it("should work with a class module", () => {
        const lazyC = (0, lazy_1.lazyFunction)(() => class {
            constructor() {
                this.a = 1;
                this.b = 2;
            }

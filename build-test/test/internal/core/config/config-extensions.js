...
describe("Config extensions", function () {
    ...
    describe("Invalid extensions", function () {
        ...
        it("Should throw the right error when trying to modify the user config", function () {
            (0, errors_1.expectHardhatError)(() => (0, config_loading_1.loadConfigAndTasks)(), errors_list_1.ERRORS.GENERAL.USER_CONFIG_MODIFIED);
        });
        it("Should have the right property path", function () {
            chai_1.assert.throws(() => (0, config_loading_1.loadConfigAndTasks)(), "userConfig.networks.asd");
        });
    });
});

...
describe("Error ranges", () => {
    ...
    it("Should have max > min", () => {
        for (const errorGroup of (0, unsafe_1.unsafeObjectKeys)(errors_list_1.ERROR_RANGES)) {
    ...
    it("Shouldn't overlap ranges", () => {
        for (const errorGroup of (0, unsafe_1.unsafeObjectKeys)(errors_list_1.ERROR_RANGES)) {
            const range = errors_list_1.ERROR_RANGES[errorGroup];
            for (const errorGroup2 of (0, unsafe_1.unsafeObjectKeys)(errors_list_1.ERROR_RANGES)) {
...
describe("Error descriptors", () => {
    it("Should have all errors inside their ranges", () => {
        for (const errorGroup of (0, unsafe_1.unsafeObjectKeys)(errors_list_1.ERRORS)) {
            const range = errors_list_1.ERROR_RANGES[errorGroup];
...
describe("applyErrorMessageTemplate", () => {
    describe("Variable names", () => {
        it("Should reject invalid variable names", () => {
            (0, errors_2.expectHardhatError)(() => (0, errors_1.applyErrorMessageTemplate)("", { "1": 1 }), errors_list_1.ERRORS.INTERNAL.TEMPLATE_INVALID_VARIABLE_NAME);
            (0, errors_2.expectHardhatError)(() => (0, errors_1.applyErrorMessageTemplate)("", { "asd%": 1 }), errors_list_1.ERRORS.INTERNAL.TEMPLATE_INVALID_VARIABLE_NAME);
            (0, errors_2.expectHardhatError)(() => (0, errors_1.applyErrorMessageTemplate)("", { "asd asd": 1 }), errors_list_1.ERRORS.INTERNAL.TEMPLATE_INVALID_VARIABLE_NAME);
        });
    });
    describe("Values", () => {
        it("shouldn't contain valid variable tags", () => {
            (0, errors_2.expectHardhatError)(() => (0, errors_1.applyErrorMessageTemplate)("%asd%", { asd: "%as%" }), errors_list_1.ERRORS.INTERNAL.TEMPLATE_VALUE_CONTAINS_VARIABLE_TAG);
            (0, errors_2.expectHardhatError)(() => (0, errors_1.applyErrorMessageTemplate)("%asd%", { asd: "%a123%" }), errors_list_1.ERRORS.INTERNAL.TEMPLATE_VALUE_CONTAINS_VARIABLE_TAG);
            (0, errors_2.expectHardhatError)(() => (0, errors_1.applyErrorMessageTemplate)("%asd%", {
                asd: { toString: () => "%asd%" },
            }), errors_list_1.ERRORS.INTERNAL.TEMPLATE_VALUE_CONTAINS_VARIABLE_TAG);
        });
        it("Shouldn't contain the %% tag", () => {
            (0, errors_2.expectHardhatError)(() => (0, errors_1.applyErrorMessageTemplate)("%asd%", { asd: "%%" }), errors_list_1.ERRORS.INTERNAL.TEMPLATE_VALUE_CONTAINS_VARIABLE_TAG);
        });
    });
    describe("Replacements", () => {
        describe("String values", () => {
            it("Should replace variable tags for the values", () => {
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd %asd% 123 %asd%", { asd: "r" }), "asd r 123 r");
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd%asd% %asd% %fgh% 123", {
                    asd: "r",
                    fgh: "b",
                }), "asdr r b 123");
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd%asd% %asd% %fgh% 123", {
        ...
        describe("Non-string values", () => {
            it("Should replace undefined values for undefined", () => {
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd %asd% 123 %asd%", { asd: undefined }), "asd undefined 123 undefined");
            });
            it("Should replace null values for null", () => {
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd %asd% 123 %asd%", { asd: null }), "asd null 123 null");
            });
            it("Should use their toString methods", () => {
                ...
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd %asd% 123 %asd%", { asd: toR }), "asd r 123 r");
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd%asd% %asd% %fgh% 123", {
                    asd: toR,
                    fgh: toB,
                }), "asdr r b 123");
        ...
        describe("%% sign", () => {
            it("Should be replaced with %", () => {
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd%%asd", {}), "asd%asd");
            });
            it("Shouldn't apply replacements if after this one a new variable tag appears", () => {
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("asd%%asd%% %asd%", { asd: "123" }), "asd%asd% 123");
            });
        });
        describe("Missing variable tag", () => {
            it("Should fail if a viable tag is missing and its value is not", () => {
                (0, errors_2.expectHardhatError)(() => (0, errors_1.applyErrorMessageTemplate)("", { asd: "123" }), errors_list_1.ERRORS.INTERNAL.TEMPLATE_VARIABLE_TAG_MISSING);
            });
        });
        describe("Missing variable", () => {
            it("Should work, leaving the variable tag", () => {
                chai_1.assert.equal((0, errors_1.applyErrorMessageTemplate)("%asd% %fgh%", { asd: "123" }), "123 %fgh%");
            });
        });
    });
});

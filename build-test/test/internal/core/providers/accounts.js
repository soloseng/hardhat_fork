...
function privateKeyToAddress(privateKey) {
    return (0, ethereumjs_util_1.bufferToHex)((0, ethereumjs_util_1.privateToAddress)((0, ethereumjs_util_1.toBuffer)(privateKey))).toLowerCase();
}
...
describe("Local accounts provider", () => {
    ...
    beforeEach(() => {
        ...
        mock.setReturnValue("net_version", (0, base_types_1.numberToRpcQuantity)(MOCK_PROVIDER_CHAIN_ID));
        mock.setReturnValue("eth_getTransactionCount", (0, base_types_1.numberToRpcQuantity)(0x8));
    ...
    it("Should throw when calling sendTransaction without gas", async () => {
        ...
        await (0, errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params }), errors_list_1.ERRORS.NETWORK.MISSING_TX_PARAM_TO_SIGN_LOCALLY, "gas");
    });
    it("Should throw when calling sendTransaction without gasPrice, maxFeePerGas and maxPriorityFeePerGas", async () => {
        ...
        await (0, errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params }), errors_list_1.ERRORS.NETWORK.MISSING_FEE_PRICE_FIELDS);
    });
    it("Should throw when calling sendTransaction with gasPrice and EIP1559 fields", async function () {
        ...
        const params2 = [
            Object.assign(Object.assign({}, params[0]), { maxFeePerGas: undefined, maxPriorityFeePerGas: (0, base_types_1.numberToRpcQuantity)(1) }),
        ];
        await (0, errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params }), errors_list_1.ERRORS.NETWORK.INCOMPATIBLE_FEE_PRICE_FIELDS);
        await (0, errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params: params2 }), errors_list_1.ERRORS.NETWORK.INCOMPATIBLE_FEE_PRICE_FIELDS);
    });
    it("Should throw when only one EIP1559 field is provided", async function () {
        ...
        await (0, errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params }), errors_list_1.ERRORS.NETWORK.MISSING_TX_PARAM_TO_SIGN_LOCALLY, "maxPriorityFeePerGas");
        await (0, errors_2.expectHardhatErrorAsync)(() => wrapper.request({ method: "eth_sendTransaction", params: params2 }), errors_list_1.ERRORS.NETWORK.MISSING_TX_PARAM_TO_SIGN_LOCALLY, "maxFeePerGas");
    });
    ...
    it("Should throw if trying to send from an account that isn't local", async () => {
        await (0, errors_2.expectHardhatErrorAsync)(() => wrapper.request({
            method: "eth_sendTransaction",
            params: [
                {
    ...
    it("should send eip1559 txs if the eip1559 fields are present", async () => {
        ...
        const rawTransaction = (0, ethereumjs_util_1.toBuffer)(mock.getLatestParams("eth_sendRawTransaction")[0]);
    ...
    it("should send access list transactions", async () => {
        ...
        const expectedRaw = "0x01f89a7b800182753094b5bc06d4548a3ac17d72b372ae1e416bf65b8e" +
    ...
    describe("eth_sign", () => {
        ...
        it("Should throw if no data is given", async () => {
            await chai_1.assert.isRejected(wrapper.request({
                method: "eth_sign",
    ...
    describe("eth_signTypedData_v4", () => {
        it("Should be compatible with EIP-712 example", async () => {
            ...
            chai_1.assert.equal(result, "0x4355c47d63924e8a72e509b65029052eb6c299d53a04e167c5775fd466751c9d07299936d304c153f6443dfa05f40ff007d72911b6f72307f996231605b915621c");
        });
    ...
    describe("personal_sign", () => {
        it("Should be compatible with geth's implementation", async () => {
            ...
            chai_1.assert.equal(result, "0x9c73dd4937a37eecab3abb54b74b6ec8e500080431d36afedb1726624587ee6710296e10c1194dded7376f13ff03ef6c9e797eb86bae16c20c57776fc69344271c");
        });
        it("Should be compatible with metamask's implementation", async () => {
            ...
            chai_1.assert.equal(result, "0x2875e4206c9fe3b229291c81f95cc4f421e2f4d3e023f5b4041daa56ab4000977010b47a3c01036ec8a6a0872aec2ab285150f003d01b0d8da60c1cceb9154181c");
        });
    });
});
describe("hdwallet provider", () => {
    ...
    describe("HDPath formatting", () => {
        ...
        it("Should throw if the path is invalid", () => {
            (0, errors_2.expectHardhatError)(() => new accounts_1.HDWalletProvider(mock, mnemonic, ""), errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH);
            (0, errors_2.expectHardhatError)(() => new accounts_1.HDWalletProvider(mock, mnemonic, "m/"), errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH);
            (0, errors_2.expectHardhatError)(() => new accounts_1.HDWalletProvider(mock, mnemonic, "m//"), errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH);
            (0, errors_2.expectHardhatError)(() => new accounts_1.HDWalletProvider(mock, mnemonic, "m/'"), errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH);
            (0, errors_2.expectHardhatError)(() => new accounts_1.HDWalletProvider(mock, mnemonic, "m/0''"), errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH);
            (0, errors_2.expectHardhatError)(() => new accounts_1.HDWalletProvider(mock, mnemonic, "ghj"), errors_list_1.ERRORS.NETWORK.INVALID_HD_PATH);
        });
    });
});
...
function validateRawEIP2930Transaction(rawTx, tx) {
    var _a;
    const common = common_1.default.forCustomChain("mainnet", { chainId: MOCK_PROVIDER_CHAIN_ID }, "berlin");
    const sentTx = tx_1.AccessListEIP2930Transaction.fromSerializedTx((0, ethereumjs_util_1.toBuffer)(rawTx), { common });
    ...
    chai_1.assert.equal(sentTx.getSenderAddress().toString(), tx.from);
    chai_1.assert.equal((_a = sentTx.to) === null || _a === void 0 ? void 0 : _a.toString(), tx.to);
    chai_1.assert.equal((0, base_types_1.numberToRpcQuantity)(sentTx.gasLimit), tx.gas);
    chai_1.assert.equal((0, base_types_1.numberToRpcQuantity)(sentTx.gasPrice), tx.gasPrice);
    chai_1.assert.equal((0, base_types_1.numberToRpcQuantity)(sentTx.nonce), tx.nonce);
    chai_1.assert.equal((0, base_types_1.numberToRpcQuantity)(sentTx.value), tx.value);
    chai_1.assert.deepEqual(accessList, tx.accessList);
}

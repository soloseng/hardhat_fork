...
describe("Hardhat context", async function () {
    describe("no context", () => {
        ...
        it("should throw when context isn't created", async function () {
            (0, errors_1.expectHardhatError)(() => context_1.HardhatContext.getHardhatContext(), errors_list_1.ERRORS.GENERAL.CONTEXT_NOT_CREATED);
        });
    });
    describe("create context but no environment", async function () {
        ...
        it("should throw when recreating hardhat context", async function () {
            context_1.HardhatContext.createHardhatContext();
            (0, errors_1.expectHardhatError)(() => context_1.HardhatContext.createHardhatContext(), errors_list_1.ERRORS.GENERAL.CONTEXT_ALREADY_CREATED);
        });
        ...
        it("should throw when HRE is not defined", async function () {
            const ctx = context_1.HardhatContext.createHardhatContext();
            (0, errors_1.expectHardhatError)(() => ctx.getHardhatRuntimeEnvironment(), errors_list_1.ERRORS.GENERAL.CONTEXT_HRE_NOT_DEFINED);
        });
    });
    describe("environment creates context", async function () {
        ...
        it("should throw when trying to set HRE", async function () {
            (0, errors_1.expectHardhatError)(() => context_1.HardhatContext.getHardhatContext().setHardhatRuntimeEnvironment(this.env), errors_list_1.ERRORS.GENERAL.CONTEXT_HRE_ALREADY_DEFINED);
        });
    });
});

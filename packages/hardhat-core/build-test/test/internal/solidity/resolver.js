...
describe("Resolver", function () {
    ...
    before("Get project path", async function () {
        projectPath = await (0, project_1.getFixtureProjectPath)(projectName);
    });
    ...
    describe("resolveSourceName", function () {
        it("Should validate the source name format", async function () {
            await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("asd\\asd"), errors_list_1.ERRORS.SOURCE_NAMES.INVALID_SOURCE_NAME_BACKSLASHES);
            await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName((0, slash_1.default)(__dirname)), errors_list_1.ERRORS.SOURCE_NAMES.INVALID_SOURCE_NAME_ABSOLUTE_PATH);
        });
        describe("Local vs library distinction", function () {
            ...
            it("Should be a library if it starts with node_modules", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("node_modules/lib/l.sol"), errors_list_1.ERRORS.RESOLVER.LIBRARY_NOT_INSTALLED);
            });
            it("Should be local if its first directory exists in the project, even it it doesn't exist", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("contracts/non-existent.sol"), errors_list_1.ERRORS.RESOLVER.FILE_NOT_FOUND);
            });
        ...
        describe("Local files", function () {
            ...
            it("Should fail if the casing is incorrect", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("contracts/C.sol"), errors_list_1.ERRORS.RESOLVER.WRONG_SOURCE_NAME_CASING);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("contracts/c.Sol"), errors_list_1.ERRORS.RESOLVER.WRONG_SOURCE_NAME_CASING);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("contractS/c.sol"), errors_list_1.ERRORS.RESOLVER.WRONG_SOURCE_NAME_CASING);
            });
        ...
        describe("Library files", function () {
            ...
            it("Should fail if the casing is incorrect", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("lib/L.sol"), errors_list_1.ERRORS.RESOLVER.WRONG_SOURCE_NAME_CASING);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("lib/l.Sol"), errors_list_1.ERRORS.RESOLVER.WRONG_SOURCE_NAME_CASING);
                ...
                if (process.platform === "win32" || process.platform === "darwin") {
                    ...
                    await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("liB/l.sol"), errors_list_1.ERRORS.RESOLVER.LIBRARY_NOT_INSTALLED);
                }
            });
            it("Should fail if the library is not installed", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("not-installed.sol"), errors_list_1.ERRORS.RESOLVER.LIBRARY_NOT_INSTALLED, "Library not-installed.sol is not installed");
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("not-installed/l.sol"), errors_list_1.ERRORS.RESOLVER.LIBRARY_NOT_INSTALLED, "Library not-installed is not installed");
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("@not-installed/contracts/l.sol"), errors_list_1.ERRORS.RESOLVER.LIBRARY_NOT_INSTALLED, "Library @not-installed/contracts is not installed");
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("@not-installed/contracts/tokens/l.sol"), errors_list_1.ERRORS.RESOLVER.LIBRARY_NOT_INSTALLED, "Library @not-installed/contracts is not installed");
            });
            it("Should fail if the library is installed byt the file not found", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveSourceName("lib/l2.sol"), errors_list_1.ERRORS.RESOLVER.LIBRARY_FILE_NOT_FOUND);
            });
        });
    });
    describe("resolveImport", function () {
        ...
        describe("Invalid imports", function () {
            it("shouldn't let you import something using http or other protocols", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "http://google.com"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_PROTOCOL);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(libraryFrom, "https://google.com"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_PROTOCOL);
            });
            it("shouldn't let you import something using backslashes", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "sub\\a.sol"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_BACKSLASH);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(libraryFrom, "sub\\a.sol"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_BACKSLASH);
            });
            it("shouldn't let you import something using an absolute path", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "/asd"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_ABSOLUTE_PATH);
            });
        });
        describe("Absolute imports", function () {
            ...
            it("shouldn't let you import something from an uninstalled library", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "non-installed/asd.sol"), errors_list_1.ERRORS.RESOLVER.IMPORTED_LIBRARY_NOT_INSTALLED);
            });
            it("should fail if importing a missing file", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "lib/asd.sol"), errors_list_1.ERRORS.RESOLVER.IMPORTED_FILE_NOT_FOUND);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "contracts/asd.sol"), errors_list_1.ERRORS.RESOLVER.IMPORTED_FILE_NOT_FOUND);
            });
            it("should fail if importing a file with the incorrect casing", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "lib/L.sol"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_WRONG_CASING);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "contracts/C.sol"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_WRONG_CASING);
            });
        ...
        describe("Relative imports", function () {
            it("shouldn't let you import something outside of the project from a local file", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "../../asd.sol"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_OUTSIDE_OF_PROJECT);
            });
            it("shouldn't let you import something from a library that is outside of it", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(libraryFrom, "../asd.sol"), errors_list_1.ERRORS.RESOLVER.ILLEGAL_IMPORT);
            });
            it("Accept non-normalized imports", async function () {
                await assertResolvedFileFromPath(resolver.resolveImport(localFrom, "../other/asd/../o.sol"), "other/o.sol", path_1.default.join(projectPath, "other/o.sol"));
            });
            it("should fail if importing a missing file", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(libraryFrom, "./asd.sol"), errors_list_1.ERRORS.RESOLVER.IMPORTED_FILE_NOT_FOUND);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "../other/asd.sol"), errors_list_1.ERRORS.RESOLVER.IMPORTED_FILE_NOT_FOUND);
            });
            it("should fail if importing a file with the incorrect casing", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(libraryFrom, "./sub/A.sol"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_WRONG_CASING);
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "./sub/A.sol"), errors_list_1.ERRORS.RESOLVER.INVALID_IMPORT_WRONG_CASING);
            });
            it("Should always treat relative imports from local files as local", async function () {
                await (0, errors_1.expectHardhatErrorAsync)(() => resolver.resolveImport(localFrom, "../not-a-library/A.sol"), errors_list_1.ERRORS.RESOLVER.IMPORTED_FILE_NOT_FOUND);
            });

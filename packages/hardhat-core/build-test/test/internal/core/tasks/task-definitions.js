...
function expectThrowParamAlreadyDefinedError(f) {
    (0, errors_1.expectHardhatError)(f, errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_ALREADY_DEFINED);
}
...
describe("SimpleTaskDefinition", () => {
    describe("construction", () => {
        ...
        it("starts with an action that throws", () => {
            (0, errors_1.expectHardhatError)(() => taskDefinition.action({}, {}, runSuperNop), errors_list_1.ERRORS.TASK_DEFINITIONS.ACTION_NOT_SET);
        });
    });
    ...
    describe("param definition rules", () => {
        ...
        describe("param name clashes with Hardhat's ones", () => {
            function testClashWith(name) {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam(name), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_CLASHES_WITH_HARDHAT_PARAM);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalParam(name), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_CLASHES_WITH_HARDHAT_PARAM);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addFlag(name), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_CLASHES_WITH_HARDHAT_PARAM);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addPositionalParam(name), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_CLASHES_WITH_HARDHAT_PARAM);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalPositionalParam(name), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_CLASHES_WITH_HARDHAT_PARAM);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addVariadicPositionalParam(name), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_CLASHES_WITH_HARDHAT_PARAM);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalVariadicPositionalParam(name), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_CLASHES_WITH_HARDHAT_PARAM);
            }
        ...
        describe("positional param rules", () => {
            describe("no mandatory positional param after an optional one", () => {
                ...
                it("throws when trying to add a new positional param", () => {
                    (0, errors_1.expectHardhatError)(() => taskDefinition.addPositionalParam("asd2"), errors_list_1.ERRORS.TASK_DEFINITIONS.MANDATORY_PARAM_AFTER_OPTIONAL);
                });
                it("throws when trying to add a new variadic positional param", () => {
                    (0, errors_1.expectHardhatError)(() => taskDefinition.addVariadicPositionalParam("asd2"), errors_list_1.ERRORS.TASK_DEFINITIONS.MANDATORY_PARAM_AFTER_OPTIONAL);
                });
            ...
            describe("no positional params after a variadic positional param", () => {
                ...
                it("should throw on adding a positional param", () => {
                    (0, errors_1.expectHardhatError)(() => taskDefinition.addPositionalParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_AFTER_VARIADIC);
                });
                it("should throw on adding an optional positional param", () => {
                    (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalPositionalParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_AFTER_VARIADIC);
                });
                it("should throw on adding another variadic param", () => {
                    (0, errors_1.expectHardhatError)(() => taskDefinition.addVariadicPositionalParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_AFTER_VARIADIC);
                });
                it("should throw on adding an optional variadic param", () => {
                    (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalVariadicPositionalParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_AFTER_VARIADIC);
                });
                describe("should still accept non-positional ones", () => {
                    it("should accept a common param", () => {
                        taskDefinition.addParam("p");
    ...
    describe("Setting params", () => {
        ...
        describe("addParam", () => {
            it("Should fail if the param name isn't camelCase", function () {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("A"), errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("Aa"), errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("0"), errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("0a"), errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("a "), errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("a-1"), errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("a_"), errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("a_b"), errors_list_1.ERRORS.TASK_DEFINITIONS.INVALID_PARAM_NAME_CASING);
            });
            ...
            it("should throw if a non-string default value is given but its type isn't set", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("p", "desc", 123), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_VALUE_WRONG_TYPE);
            });
            it("should throw if a default value is set to a mandatory param", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addParam("p", "desc", 123, types.int, false), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_IN_MANDATORY_PARAM);
            });
        });
        describe("addOptionalParam", () => {
            ...
            it("should throw if a non-string default value is given but its type isn't set", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalParam("p", "desc", 123), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_VALUE_WRONG_TYPE);
            });
        });
        describe("addFlag", () => {
        ...
        describe("addPositionalParam", () => {
            ...
            it("should throw if a non-string default value is given but its type isn't set", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addPositionalParam("p", "desc", 123), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_VALUE_WRONG_TYPE);
            });
            it("should throw if a default value is set to a mandatory param", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addPositionalParam("p", "desc", 123, types.int, false), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_IN_MANDATORY_PARAM);
            });
        ...
        describe("addOptionalPositionalParam", () => {
            ...
            it("should throw if a non-string default value is given but its type isn't set", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalPositionalParam("p", "desc", 123), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_VALUE_WRONG_TYPE);
            });
        });
        describe("addVariadicPositionalParam", () => {
            ...
            it("should throw if a non-string default value is given but its type isn't set", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addVariadicPositionalParam("p", "desc", 123), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_VALUE_WRONG_TYPE);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addVariadicPositionalParam("p", "desc", [123]), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_VALUE_WRONG_TYPE);
            });
            it("should throw if a default value is set to a mandatory param", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addVariadicPositionalParam("p", "desc", 123, types.int, false), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_IN_MANDATORY_PARAM);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addVariadicPositionalParam("p", "desc", [123], types.int, false), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_IN_MANDATORY_PARAM);
            });
            it("should set isOptional if default value is provided", () => {
        ...
        describe("addOptionalVariadicPositionalParam", () => {
            ...
            it("should throw if a non-string default value is given but its type isn't set", () => {
                (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalVariadicPositionalParam("p", "desc", 123), errors_list_1.ERRORS.TASK_DEFINITIONS.DEFAULT_VALUE_WRONG_TYPE);
                (0, errors_1.expectHardhatError)(() => taskDefinition.addOptionalVariadicPositionalParam("p", "desc", [
                    123,
            ...
            describe("tasks", () => {
                ...
                describe("When using non-cli argument types", () => {
                    it("Should throw on addParam", () => {
                        (0, errors_1.expectHardhatError)(() => task.addParam("p", "p", undefined, types.any), errors_list_1.ERRORS.TASK_DEFINITIONS.CLI_ARGUMENT_TYPE_REQUIRED);
                    });
                    it("Should  throw on addOptionalParam", () => {
                        (0, errors_1.expectHardhatError)(() => task.addOptionalParam("p", "p", "asd", types.any), errors_list_1.ERRORS.TASK_DEFINITIONS.CLI_ARGUMENT_TYPE_REQUIRED);
                    });
                    it("Should  throw on addPositionalParam", () => {
                        (0, errors_1.expectHardhatError)(() => task.addPositionalParam("p", "p", undefined, types.any), errors_list_1.ERRORS.TASK_DEFINITIONS.CLI_ARGUMENT_TYPE_REQUIRED);
                    });
                    it("Should  throw on addOptionalPositionalParam", () => {
                        (0, errors_1.expectHardhatError)(() => task.addOptionalPositionalParam("p", "p", "asd", types.any), errors_list_1.ERRORS.TASK_DEFINITIONS.CLI_ARGUMENT_TYPE_REQUIRED);
                    });
                    it("Should  throw on addVariadicPositionalParam", () => {
                        (0, errors_1.expectHardhatError)(() => task.addVariadicPositionalParam("p", "p", undefined, types.any), errors_list_1.ERRORS.TASK_DEFINITIONS.CLI_ARGUMENT_TYPE_REQUIRED);
                    });
                    it("Should  throw on addVariadicPositionalParam", () => {
                        (0, errors_1.expectHardhatError)(() => task.addOptionalVariadicPositionalParam("p", "p", "asd", types.any), errors_list_1.ERRORS.TASK_DEFINITIONS.CLI_ARGUMENT_TYPE_REQUIRED);
                    });
                });
            });
            describe("subtasks", () => {
...
describe("OverriddenTaskDefinition", () => {
    ...
    describe("Param definitions can be added only in compatible cases", () => {
        ...
        it("should throw if adding a param of same name that was already defined in parent task", () => {
            ...
            (0, errors_1.expectHardhatError)(() => overriddenTask.addFlag(definedParamName), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_ALREADY_DEFINED);
            // expect PARAM_ALREADY_DEFINED for add optional param using addParam method
            (0, errors_1.expectHardhatError)(() => overriddenTask.addParam(definedParamName, undefined, undefined, undefined, true), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_ALREADY_DEFINED);
            // expect PARAM_ALREADY_DEFINED for add optional param using addParam method
            (0, errors_1.expectHardhatError)(() => overriddenTask.addOptionalParam(definedParamName, undefined, undefined, undefined), errors_list_1.ERRORS.TASK_DEFINITIONS.PARAM_ALREADY_DEFINED);
        });
        it("should throw if addParam is called with isOptional = false", () => {
            (0, errors_1.expectHardhatError)(() => overriddenTask.addParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.OVERRIDE_NO_MANDATORY_PARAMS);
        });
        ...
        it("should throw if addPositionalParam is called", () => {
            (0, errors_1.expectHardhatError)(() => overriddenTask.addPositionalParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.OVERRIDE_NO_POSITIONAL_PARAMS);
        });
        it("should throw if addOptionalPositionalParam is called", () => {
            (0, errors_1.expectHardhatError)(() => overriddenTask.addOptionalPositionalParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.OVERRIDE_NO_POSITIONAL_PARAMS);
        });
        it("should throw if addVariadicPositionalParam is called", () => {
            (0, errors_1.expectHardhatError)(() => overriddenTask.addVariadicPositionalParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.OVERRIDE_NO_VARIADIC_PARAMS);
        });
        it("should throw if addOptionalVariadicPositionalParam is called", () => {
            (0, errors_1.expectHardhatError)(() => overriddenTask.addOptionalVariadicPositionalParam("p"), errors_list_1.ERRORS.TASK_DEFINITIONS.OVERRIDE_NO_VARIADIC_PARAMS);
        });
    });
});

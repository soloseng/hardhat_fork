...
describe("argumentTypes", () => {
    ...
    describe("boolean type", () => {
        ...
        it("should throw the right error on invalid values", () => {
            (0, errors_1.expectHardhatError)(() => types.boolean.parse("arg", "asd1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.boolean.parse("arg", "f"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.boolean.parse("arg", "t"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.boolean.parse("arg", "1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.boolean.parse("arg", "0"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.boolean.parse("arg", ""), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
        });
    });
    describe("int type", () => {
        ...
        it("should fail with incorrect values", () => {
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", ""), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", "1."), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", ".1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", "0.1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", "asdas"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", "a1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", "1a"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", "1 1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.int.parse("arg", "x123"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
        });
    });
    describe("float type", () => {
        ...
        it("should fail with incorrect values", () => {
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", ""), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "."), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", ".."), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "1..1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "1.asd"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "asd.123"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "asdas"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "a1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "1a"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "1 1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
            (0, errors_1.expectHardhatError)(() => types.float.parse("arg", "x123"), errors_list_1.ERRORS.ARGUMENTS.INVALID_VALUE_FOR_TYPE);
        });
    });
    describe("Input file type", () => {
        ...
        it("Should throw if the file doesnt exist", () => {
            (0, errors_1.expectHardhatError)(() => types.inputFile.parse("A file", "NON_EXISTENT_FILE"), errors_list_1.ERRORS.ARGUMENTS.INVALID_INPUT_FILE);
        });
        it("Should throw if the file isn't readable", async function () {
            ...
            (0, errors_1.expectHardhatError)(() => types.inputFile.parse("A file", "A"), errors_list_1.ERRORS.ARGUMENTS.INVALID_INPUT_FILE);
            await fsExtra.unlink("A");
        });
        it("Should throw if a directory is given", () => {
            (0, errors_1.expectHardhatError)(() => types.inputFile.parse("A file", __dirname), errors_list_1.ERRORS.ARGUMENTS.INVALID_INPUT_FILE);
        });
    });
    describe("JSON type", () => {
        it("Should fail if the argument isn't JSON", () => {
            (0, errors_1.expectHardhatError)(() => types.json.parse("j", "a"), errors_list_1.ERRORS.ARGUMENTS.INVALID_JSON_ARGUMENT);
            (0, errors_1.expectHardhatError)(() => types.json.parse("j", "{a:1"), errors_list_1.ERRORS.ARGUMENTS.INVALID_JSON_ARGUMENT);
            (0, errors_1.expectHardhatError)(() => types.json.parse("j", "[1],"), errors_list_1.ERRORS.ARGUMENTS.INVALID_JSON_ARGUMENT);
        });

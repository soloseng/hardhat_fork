...
describe("project structure", () => {
    ...
    describe("getUserConfigPath", () => {
        it("should throw if cwd is not inside a project", () => {
            (0, errors_1.expectHardhatError)(() => (0, project_structure_1.getUserConfigPath)(), errors_list_1.ERRORS.GENERAL.NOT_INSIDE_PROJECT);
        });
        describe("Inside a project", () => {
            (0, project_1.useFixtureProject)("default-config-project");
            let configPath;
            ...
            it("should work from the project root", () => {
                chai_1.assert.equal((0, project_structure_1.getUserConfigPath)(), configPath);
            });
...
describe("getRecommendedGitIgnore", () => {
    it("Should return the one from this repo", async () => {
        ...
        chai_1.assert.equal(await (0, project_structure_1.getRecommendedGitIgnore)(), content);
    });
});

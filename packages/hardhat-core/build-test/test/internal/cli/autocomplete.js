...
describe("autocomplete", function () {
    ...
    describe("basic project", () => {
        ...
        it("shouldn't suggest an already used flag", async () => {
            ...
            (0, chai_1.expect)(suggestions).same.deep.members(coreParamsWithoutVerbose);
        });
        ...
        it("should suggest params after some param", async () => {
            ...
            (0, chai_1.expect)(suggestions).same.deep.members(coreParamsWithoutNetwork);
        });
        ...
        it("should not suggest params after a task if the last word doesn't start with --", async () => {
            ...
            (0, chai_1.expect)(suggestions).to.equal(autocomplete_1.HARDHAT_COMPLETE_FILES);
        });
    ...
    describe("overriden task", () => {
        (0, project_1.useFixtureProject)("autocomplete/overriden-task");
        after(() => {
            (0, reset_1.resetHardhatContext)();
        });

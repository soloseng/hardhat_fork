...
describe("ArgumentsParser", () => {
    ...
    it("Should throw if a param name CLA isn't all lowercase", () => {
        (0, errors_1.expectHardhatError)(() => ArgumentsParser_1.ArgumentsParser.cLAToParamName("--showStackTraces"), errors_list_1.ERRORS.ARGUMENTS.PARAM_NAME_INVALID_CASING);
        (0, errors_1.expectHardhatError)(() => ArgumentsParser_1.ArgumentsParser.cLAToParamName("--showstackTraces"), errors_list_1.ERRORS.ARGUMENTS.PARAM_NAME_INVALID_CASING);
        (0, errors_1.expectHardhatError)(() => ArgumentsParser_1.ArgumentsParser.cLAToParamName("--show-stack-Traces"), errors_list_1.ERRORS.ARGUMENTS.PARAM_NAME_INVALID_CASING);
    });
    ...
    describe("hardhat arguments", () => {
        ...
        it("should fail trying to parse task arguments before taskname", () => {
            ...
            (0, errors_1.expectHardhatError)(() => argumentsParser.parseHardhatArguments(hardhat_params_1.HARDHAT_PARAM_DEFINITIONS, envArgs, rawCLAs), errors_list_1.ERRORS.ARGUMENTS.UNRECOGNIZED_COMMAND_LINE_ARG);
        });
        ...
        it("should fail trying to parse a repeated argument", () => {
            ...
            (0, errors_1.expectHardhatError)(() => argumentsParser.parseHardhatArguments(hardhat_params_1.HARDHAT_PARAM_DEFINITIONS, envArgs, rawCLAs), errors_list_1.ERRORS.ARGUMENTS.REPEATED_PARAM);
        });
    ...
    describe("tasks arguments", () => {
        ...
        it("Should throw the right error if the last CLA is a non-flag --param", () => {
            ...
            taskDefinition = new task_definitions_1.SimpleTaskDefinition("t", false)
                ...
                .setAction(async () => { });
            (0, errors_1.expectHardhatError)(() => argumentsParser.parseTaskArguments(taskDefinition, rawCLAs), errors_list_1.ERRORS.ARGUMENTS.MISSING_TASK_ARGUMENT);
        });
    });
});

...
async function storeAllArtifacts(sourceName, artifacts) {
    ...
    for (const [name, output] of Object.entries(COMPILER_OUTPUTS)) {
        const artifact = (0, artifacts_1.getArtifactFromContractOutput)(sourceName, name, output);
...
describe("Artifacts class", function () {
    describe("getArtifactFromContractOutput", function () {
        it("Should always return a bytecode, linkReference, deployedBytecode and deployedLinkReferences", function () {
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "Interface", Object.assign(Object.assign({}, COMPILER_OUTPUTS.Interface), { evm: undefined }));
            ...
            const artifact2 = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "Interface", Object.assign(Object.assign({}, COMPILER_OUTPUTS.Interface), { evm: {} }));
            ...
            const artifact3 = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "Interface", Object.assign(Object.assign({}, COMPILER_OUTPUTS.Interface), { evm: { bytecode: {} } }));
        ...
        it("Should return the right artifact for an interface", function () {
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "Interface", COMPILER_OUTPUTS.Interface);
            const expectedArtifact = {
                _format: "hh-sol-artifact-1",
                contractName: "Interface",
                sourceName: "source.sol",
        ...
        it("Should return the right artifact for a library", function () {
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "Lib", COMPILER_OUTPUTS.Lib);
            const expectedArtifact = {
                _format: "hh-sol-artifact-1",
                contractName: "Lib",
                sourceName: "source.sol",
        ...
        it("Should return the right artifact for a contract without libs", function () {
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "WithBytecodeNoLibs", COMPILER_OUTPUTS.WithBytecodeNoLibs);
            const expectedArtifact = {
                _format: "hh-sol-artifact-1",
        ...
        it("Should return the right artifact for a contract with libs", function () {
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "WithBytecodeAndLibs", COMPILER_OUTPUTS.WithBytecodeAndLibs);
            const expectedArtifact = {
                _format: "hh-sol-artifact-1",
        ...
        it("Should return the right artifact for an abstract contract without libs", function () {
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "WithoutBytecodeNoLibs", COMPILER_OUTPUTS.WithoutBytecodeNoLibs);
            const expectedArtifact = {
                _format: "hh-sol-artifact-1",
        ...
        it("Should return the right artifact for an abstract contract with libs", function () {
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", "WithoutBytecodeWithLibs", COMPILER_OUTPUTS.WithoutBytecodeWithLibs);
            const expectedArtifact = {
                _format: "hh-sol-artifact-1",
    ...
    describe("Artifacts reading and saving", function () {
        ...
        it("It should write and read (async) the right artifacts", async function () {
            for (const [name, output] of Object.entries(COMPILER_OUTPUTS)) {
                const artifact = (0, artifacts_1.getArtifactFromContractOutput)("source.sol", name, output);
        ...
        it("Should save the debug file if a build info is provided", async function () {
            ...
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)(sourceName, contractName, output);
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
        ...
        it("Should find the right artifact even if the source name has slashes", async function () {
            const output = COMPILER_OUTPUTS.Lib;
            const name = "Lib";
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("folder/source.sol", name, output);
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            const storedArtifact = await artifacts.readArtifact(name);
            chai_1.assert.deepEqual(storedArtifact, artifact);
        ...
        it("Should throw when reading a non-existent contract (async)", async function () {
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await (0, errors_1.expectHardhatErrorAsync)(() => artifacts.readArtifact("NonExistent"), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND);
        });
        it("Should throw when reading a non-existent contract (sync)", async function () {
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            (0, errors_1.expectHardhatError)(() => artifacts.readArtifactSync("NonExistent"), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND);
        });
        it("Should throw when multiple artifacts match a given name (async)", async function () {
            const output = COMPILER_OUTPUTS.Lib;
            const name = "Lib";
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("Lib.sol", name, output);
            const artifact2 = (0, artifacts_1.getArtifactFromContractOutput)("Lib2.sol", name, output);
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            await artifacts.saveArtifactAndDebugFile(artifact2, "");
            await (0, errors_1.expectHardhatErrorAsync)(() => artifacts.readArtifact(name), errors_list_1.ERRORS.ARTIFACTS.MULTIPLE_FOUND, `Lib.sol:Lib${os.EOL}Lib2.sol:Lib`);
        });
        it("Should throw when multiple artifacts match a given name (sync)", async function () {
            ...
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            await artifacts.saveArtifactAndDebugFile(artifact2, "");
            (0, errors_1.expectHardhatError)(() => artifacts.readArtifactSync(name), errors_list_1.ERRORS.ARTIFACTS.MULTIPLE_FOUND, `Lib.sol:Lib${os.EOL}Lib2.sol:Lib`);
        });
        it("Should throw with typo suggestions when no artifacts match a given name (async)", async function () {
            ...
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            await (0, errors_1.expectHardhatErrorAsync)(() => artifacts.readArtifact(typo), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND, /Did you mean "Lib"\?$/);
        });
        it("Should throw with typo suggestions when no artifacts match a given name (sync)", async function () {
            ...
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            (0, errors_1.expectHardhatError)(() => artifacts.readArtifactSync(typo), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND, /Did you mean "Lib"\?$/);
        });
        it("Should throw with fully qualified names for identical suggestions (async)", async function () {
            ...
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("Lib.sol", name, output);
            const artifact2 = (0, artifacts_1.getArtifactFromContractOutput)("Lib2.sol", name, output);
            const artifact3 = (0, artifacts_1.getArtifactFromContractOutput)("Lab.sol", name3, output);
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            await artifacts.saveArtifactAndDebugFile(artifact2, "");
            ...
            const expected = ["Lab", "Lib.sol:Lib", "Lib2.sol:Lib"]
                .map((n) => `  * ${n}`)
                .join(os.EOL);
            await (0, errors_1.expectHardhatErrorAsync)(() => artifacts.readArtifact(typo), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND, expected);
        });
        it("Should throw with fully qualified names for identical suggestions (sync)", async function () {
            ...
            const expected = ["Lab", "Lib.sol:Lib", "Lib2.sol:Lib"]
                .map((n) => `  * ${n}`)
                .join(os.EOL);
            (0, errors_1.expectHardhatError)(() => artifacts.readArtifactSync(typo), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND, expected);
        });
        it("Should throw with typo suggestions when no artifacts match a given fully qualified name (async)", async function () {
            ...
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            await (0, errors_1.expectHardhatErrorAsync)(() => artifacts.readArtifact(typo), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND, /Did you mean "Lib\.sol:Lib"\?/);
        });
        it("Should throw with typo suggestions when no artifacts match a given fully qualified name (sync)", async function () {
            ...
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            (0, errors_1.expectHardhatError)(() => artifacts.readArtifactSync(typo), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND, /Did you mean "Lib\.sol:Lib"\?/);
        });
        it("Should throw with multiple typo suggestions if they are the same distance from a given fully qualified name (async)", async function () {
            ...
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)("Lib.sol", name, output);
            const artifact2 = (0, artifacts_1.getArtifactFromContractOutput)("Lob.sol", name2, output);
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            await artifacts.saveArtifactAndDebugFile(artifact2, "");
        ...
        it("Should not throw with suggestions if the given contract name is further than EDIT_DISTANCE_THRESHOLD (async)", async function () {
            ...
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            await (0, errors_1.expectHardhatErrorAsync)(() => artifacts.readArtifact(typo), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND, /not found\.\s*$/);
        });
        it("Should not throw with suggestions if the given contract name is further than EDIT_DISTANCE_THRESHOLD (sync)", async function () {
            ...
            const artifacts = new artifacts_1.Artifacts(this.tmpDir);
            await artifacts.saveArtifactAndDebugFile(artifact, "");
            (0, errors_1.expectHardhatError)(() => artifacts.readArtifactSync(typo), errors_list_1.ERRORS.ARTIFACTS.NOT_FOUND, /not found\.\s*$/);
        });
        ...
        it("Should be possible to get an absolute path to an artifact given a fully qualified name", async function () {
            ...
            const artifactPath = artifacts.formArtifactPathFromFullyQualifiedName(fullyQualifiedName);
        ...
        it("Should be possible to get a build info from a fully qualified name", async function () {
            ...
            const artifact = (0, artifacts_1.getArtifactFromContractOutput)(sourceName, contractName, output);
            await artifacts.saveArtifactAndDebugFile(artifact, buildInfoPath);
            const storedBuildInfo = await artifacts.getBuildInfo((0, contract_names_1.getFullyQualifiedName)(sourceName, contractName));

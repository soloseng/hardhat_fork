...
function leftPad32(value) {
    return (0, ethereumjs_util_1.setLengthLeft)((0, ethereumjs_util_1.toBuffer)(value), 32).toString("hex");
}
...
describe("leftPad32", () => {
    ...
    it("correctly pads buffers", () => {
        const buffer = (0, ethereumjs_util_1.toBuffer)("0x6b175474e89094c44da98b954eedeac495271d0f");

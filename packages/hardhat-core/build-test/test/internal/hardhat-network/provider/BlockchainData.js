...
describe("BlockchainData", () => {
    ...
    function createBlock(number) {
        return block_1.Block.fromBlockData({ header: { number } });
    }
    beforeEach(() => {
    ...
    describe("removeBlock", () => {
        ...
        it("removes associated transaction receipts", () => {
            ...
            const receipt = (0, blockchain_1.createTestReceipt)(tx);
    ...
    describe("getLogs", () => {
        it("can retrieve logs for a block from receipts", () => {
            ...
            const log1 = (0, blockchain_1.createTestLog)(100);
            const log2 = (0, blockchain_1.createTestLog)(100);
            const tx1 = (0, blockchain_1.createTestTransaction)();
            const receipt1 = (0, blockchain_1.createTestReceipt)(tx1, [log1, log2]);
            const tx2 = (0, blockchain_1.createTestTransaction)();
            const log3 = (0, blockchain_1.createTestLog)(100);
            const receipt2 = (0, blockchain_1.createTestReceipt)(tx2, [log3]);
            block1.transactions.push(tx1, tx2);
            const block2 = createBlock(101);
            const tx3 = (0, blockchain_1.createTestTransaction)();
            const log4 = (0, blockchain_1.createTestLog)(101);

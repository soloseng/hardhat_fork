...
describe("Keys derivation", function () {
    describe("deriveKeyFromMnemonicAndPath", function () {
        it("Should derive the right keys", function () {
            ...
            const derivedPk = (0, keys_derivation_1.deriveKeyFromMnemonicAndPath)(mnemonic, path);
            const address = (0, ethereumjs_util_1.bufferToHex)((0, ethereumjs_util_1.privateToAddress)(derivedPk));
            chai_1.assert.equal((0, ethereumjs_util_1.toChecksumAddress)(address), "0x9CFE3206BD8beDC01c1f04E644eCd3e96a16F095");
        });
    });
});

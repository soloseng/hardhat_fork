...
const baseBlockResponse = {
    ...
    sha3Uncles: (0, io_ts_1.optional)(base_types_1.rpcHash),
    ...
    difficulty: (0, io_ts_1.optional)(base_types_1.rpcQuantity),
    totalDifficulty: base_types_1.rpcQuantity,
    extraData: base_types_1.rpcData,
    size: base_types_1.rpcQuantity,
    gasLimit: (0, io_ts_1.optional)(base_types_1.rpcQuantity),
    gasUsed: base_types_1.rpcQuantity,
    timestamp: base_types_1.rpcQuantity,
    uncles: (0, io_ts_1.optional)(t.array(base_types_1.rpcHash, "HASH Array")),
